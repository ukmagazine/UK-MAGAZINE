...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: 'سرگرمی',
    shortName: 'سرگرمی',
    description: 'اخبار سرگرمی به زبان فارسی: فیلم، سریال، تلویزیون، موسیقی، کتاب و چهره‌های محبوب بریتانیا.',
    standfirst:
      'فیلم، سریال، تلویزیون، موسیقی و کتاب را در این صفحه دنبال می‌کنیم: اکران‌ها، بازگشت برنامه‌های محبوب، جایزه‌ها و خبر چهره‌ها. برنامه‌هایی که تاریخ و بلیت دارند در بخش «رویداد» معرفی می‌شوند.',
    tint: '#A32D6B',
    topics: ['فیلم', 'سریال', 'تلویزیون', 'موسیقی', 'کتاب', 'چهره‌ها'],
    inPrimaryNav: true,
  },
  {
    slug: 'health',
