...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      >
        <p>
          مجله بریتانیا (UK Magazine) مرجع تخصصی اخبار و اطلاعات کاربردی برای جامعه‌ی
          فارسی‌زبان مقیم بریتانیاست. تمرکز ما بر اخباری است که مستقیماً بر زندگی
          روزمره‌ی شما در این کشور تأثیر می‌گذارد؛ از قوانین جدید مهاجرتی و تغییرات
          اقتصادی گرفته، تا رویدادهای فرهنگی و راهنمای زندگی در شهرهای مختلف.
        </p>
