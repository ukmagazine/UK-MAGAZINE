  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
        className={cn(
          'fixed inset-0 z-menu bg-ink/50 backdrop-blur-[2px] transition-opacity duration-300 ease-editorial xl:hidden',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 start-0 z-menu flex w-[88%] max-w-sm flex-col bg-surface shadow-overlay transition-transform duration-[340ms] ease-editorial xl:hidden',
      ...
      >
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain px-5 py-6">
              <button
                ...
                className="flex min-h-[48px] w-full items-center gap-3 border border-line px-4 text-left text-sm text-ink-soft transition-colors hover:border-ink hover:text-ink"
              >
              ...
              <div className="mt-7 grid grid-cols-2 gap-3">
                <Link
                  href="/bookmarks"
                  className="inline-flex min-h-[48px] items-center justify-center gap-2 border border-line text-sm font-medium text-ink transition-colors hover:border-ink hover:text-brand-red"
                >
                ...
                <Link
                  href="/newsletter"
                  className="inline-flex min-h-[48px] items-center justify-center bg-ink text-sm font-semibold text-white transition-colors hover:bg-brand-red"
                >
                  {t.nav.subscribe}
                </Link>
              </div>
